...
{
    //---各種宣言---//
    std::unordered_map<tstring, std::function< void(D3DXVECTOR3, D3DXVECTOR3) >> Function = { { TEXT("FIREGIMMCK"), InstantiateFireGimmick },{ TEXT("ICEGIMMICK"), InstantiateIceGimmick },{ TEXT("WOODGIMMICK"), InstantiateWoodGimmick } };
